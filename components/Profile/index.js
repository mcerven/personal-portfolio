    ...
    <div className="text-primary transition-colors-300">
      <div className="flex md:flex-row flex-wrap justify-center">
        <div className="md:w-1/3">
          <img className="rounded-full w-60 md:w-80" src="/assets/images/lego_avatar.jpg" alt="Profile picture" />
        </div>
        <div className="w-2/3 pl-8">
          <h1 className="text-5xl text-accent tracking-wide">
            Hello, I'm Mario Cerven
          </h1>
          <div className="flex flex-row pt-3 pb-2 text-secondary">
            <SocialMediaLink title="LinkedIn" href="https://linkedin.com/in/mariocerven">
              <svg aria-hidden="true" focusable="false" data-icon="linkedin" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
function SocialMediaLink({title, href, children}) {
  return (
